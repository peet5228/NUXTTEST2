                        ...
                        <v-table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="border text-center">รายชื่อกรรมการประเมิน</th>
                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :key="items.id_eva">
                                    ...
                                    <td class="text-center border">
                                        <v-btn :color="bg(items.status_commit)" size="small" class="text-white">{{ items.status_commit === 'y' ? 'ประเมินแล้ว' : 'ยังไม่ได้ประเมิน' }}</v-btn>
                                    </td>
                                </tr>

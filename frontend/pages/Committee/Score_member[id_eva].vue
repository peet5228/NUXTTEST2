        ...
        <v-row>
            <v-col cols="12">
                <v-form v-if="user.status_eva === 2 || user.status_eva === 3">
                    <h1 class="text-h5 font-weight-bold">คะแนนประเมินผู้รับการประเมิน</h1>
                        ...
                        <v-col cols="12">
                            ...
                            <v-table class="table">
                                <tr>
                                    ...
                                    <th class="bg-grey text-black pa-1 border" style="width: 10%;">รายละเอียด</th>
                                    <th class="bg-grey text-black pa-1 border" style="width: 10%;">ไฟล์ที่แนบ</th>
                                ...
                                <tr v-for="indicate in topic.indicates" :key="indicate.id_indicate">
                                    ...
                                    <td class="text-center border pa-1"><v-btn v-if="indicate.file_eva" color="blue" size="small" @click="viweFile(indicate.file_eva)">ดูไฟล์</v-btn><span v-else>-</span></td>
                                    <td class="text-center border pa-1">{{ indicate.score_member*indicate.point_indicate || 0 }}</td>
                                </tr>
                            </v-table>
                        </v-col>
                    </v-row>
